  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 mt-7 mb-7 px-4 md:px-8 lg:px-16 pt-8">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="flex flex-col justify-start items-start text-left flex-1"
      >
      ...
      <motion.div
        ...
        className="h-[200px] w-full sm:h-[250px] sm:w-[250px] md:h-[300px] md:w-[300px] lg:h-[300px] lg:w-[300px] mx-auto lg:mx-0 shadow-lg rounded-lg"
        style={{
