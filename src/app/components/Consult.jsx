...
const Consult = () => {
  ...
  viewport={{ once: true }}
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-full md:w-2/3 lg:w-1/2 xl:w-1/3 h-full bg-[#535fab] flex items-center justify-center">
        <div className="flex flex-col px-6 py-10 md:px-10 lg:px-12 xl:px-16">
          <h1 className="text-3xl md:text-4xl font-bold text-white text-center mt-10">
            Zinga's Custom Window Coverings
          </h1>

          <p className="mt-6 text-xl md:text-2xl text-center font-semibold text-white">
            STEP 1: Complimentary In-Home Consultation
          </p>
          <p className="mt-2 text-sm md:text-base text-center font-semibold text-white">
