const Footer = () => {
    const linkSections = [
        ...
        },
        {
            ...
            links: ["Zinga’s West Palm Beach", "Zinga’s Vero Beach", "Zinga’s Dallas", "Zinga’s Fort Myers", "Zinga’s Sarasota","Zinga’s Tampa","Zinga’s Nashville","Zinga’s Indianapolis"]
        },
        {
            title: "Follow Us",
    ...
    return (
        <div className="px-6 bg-[#656e7d] md:px-16 lg:px-24 xl:px-32 ">
...
<a href="#" className="hover:-translate-y-0.5 transition-all duration-300">
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
                    ...
                    <p className="max-w-[200px] mt-6">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Rerum unde quaerat eveniet cumque accusamus atque qui error quo enim fugiat?</p>
                </div>
