...
import { assets, ShuttersproductsData} from '@/assets/assets'
import Shutterscard from './Shutterscard'
import { motion } from 'framer-motion';

const ShuttersProducts = () => {
  ...
  return (
    <div>
      ...
      {ShuttersproductsData.map((product,index)=>(
        <div key={index}>
          <Shutterscard product={product}/>
          </div>
      ))}
          </motion.div>
...
export default ShuttersProducts
